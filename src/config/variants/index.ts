...
export const WORLD_VARIANT: VariantConfig = {
  ...
  panels: {
    ...
    signals: { id: 'signals', title: '热门信号', side: 'left', refreshIntervalMs: 180_000, bootstrapKeys: ['signals'] },
    correlation: { id: 'correlation', title: '关联引擎', side: 'left', refreshIntervalMs: 120_000 },
    liveStreams: { id: 'liveStreams', title: '直播信号', side: 'left', refreshIntervalMs: 180_000, bootstrapKeys: ['streamStatuses'] },
    ...
    liveMatches: { id: 'liveMatches', title: '实时比分', side: 'right', refreshIntervalMs: 90_000, bootstrapKeys: ['liveMatches'] },
