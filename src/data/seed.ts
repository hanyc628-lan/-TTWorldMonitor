...
export const SIGNALS: Signal[] = [
  {
    id: 's-europe-ms',
    type: 'result',
    title: 'WTT Europe Smash：Félix Lebrun 4-1 击败张本智和，夺得男单大满贯首冠',
    source: 'WTT',
  ...
  },
  {
    id: 's-europe-ws',
    type: 'result',
    title: 'WTT Europe Smash：王曼昱 4-2 战胜王艺迪，斩获女单大满贯第三冠',
    source: 'WTT',
  ...
  },
  {
    id: 's-europe-md',
    type: 'result',
    title: 'WTT Europe Smash：勒布伦兄弟夺男双冠军，林诗栋/蒯曼获混双金牌',
    source: 'WTT',
  ...
  },
  {
    id: 's-pingchao-2026',
    type: 'result',
    title: '2026乒超常规赛收官：山东魏桥男团12连胜锁定头名，女团四强出炉',
    source: '乒超',
  ...
  },
  {
    id: 's-tleague',
    type: 'result',
    title: 'T联赛焦点战：张本智和 3-2 宇田幸矢，Kinoshita Tokyo 领先琉球',
    source: 'T-League',
  ...
  },
  {
    id: 's10',
    type: 'result',
    title: '德甲焦点战：樊振东 3-1 击败邱党，萨尔布吕肯领先杜塞多夫',
    source: 'TTBL',
