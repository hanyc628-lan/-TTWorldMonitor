...
export const CLUBS: Club[] = [
  ...
  { id: 'saarbrucken', name: '1. FC Saarbrücken-TT', leagueId: 'ttbl', city: 'Saarbrücken', country: 'GER', lat: 49.24, lng: 7.0, notablePlayers: ['FAN Zhendong', 'Darko JORGIC', 'Yuan Ruichen'] },
  { id: 'borussia', name: 'Borussia Düsseldorf', leagueId: 'ttbl', city: 'Düsseldorf', country: 'GER', lat: 51.23, lng: 6.78, notablePlayers: ['QIU Dang', 'YU Ziyang', 'Benedikt DUDA'] },
  { id: 'bremen', name: 'TTF Liebherr Ochsenhausen', leagueId: 'ttbl', city: 'Ochsenhausen', country: 'GER', lat: 48.07, lng: 9.95, notablePlayers: ['Dang Qiu', 'Ruwen Filus'] },
  { id: 'grizzly', name: 'Grizzly Adams Mißbach', leagueId: 'ttbl', city: 'Mißbach', country: 'GER', lat: 47.87, lng: 11.97, notablePlayers: ['Patrick Franziska'] },
  { id: 'shandong', name: '山东魏桥', leagueId: 'pingchao', city: '威海', country: 'CHN', lat: 37.5, lng: 122.1, notablePlayers: ['WANG Chuqin', 'SUN Yingsha'] },
  { id: 'shanghai', name: '上海地产', leagueId: 'pingchao', city: '上海', country: 'CHN', lat: 31.2, lng: 121.5, notablePlayers: ['XU Xin', 'Zhou Kai'] },
  { id: 'shenzhen', name: '深圳大学', leagueId: 'pingchao', city: '深圳', country: 'CHN', lat: 22.54, lng: 114.06, notablePlayers: ['CHEN Meng', 'WANG Manyu'] },
  { id: 'ningbo', name: '宁波海曙', leagueId: 'pingchao', city: '宁波', country: 'CHN', lat: 29.87, lng: 121.55, notablePlayers: ['YUAN Licen', 'CHEN Yuanyu'] },
  { id: 'huangshi', name: '黄石基地', leagueId: 'pingchao', city: '黄石', country: 'CHN', lat: 30.2, lng: 115.03, notablePlayers: ['LIN Shidong', 'KUAI Man'] },
  { id: 'kinoshita', name: 'Kinoshita Meister Tokyo', leagueId: 't-league', city: 'Tokyo', country: 'JPN', lat: 35.68, lng: 139.77, notablePlayers: ['HARIMOTO Tomokazu', 'HARIMOTO Miwa'] },
  { id: 'ryukyu', name: '琉球 Asteeda', leagueId: 't-league', city: 'Okinawa', country: 'JPN', lat: 26.21, lng: 127.68, notablePlayers: ['UDA Yoshito', 'MORI Hayato'] },
  { id: 'kawasaki', name: '川崎 Frontale', leagueId: 't-league', city: 'Kawasaki', country: 'JPN', lat: 35.53, lng: 139.70, notablePlayers: ['MIZUTANI Jun', 'MATSUDAIRA Kenta'] },
  { id: 'shizuoka', name: '静岡 Glanz', leagueId: 't-league', city: 'Shizuoka', country: 'JPN', lat: 34.98, lng: 138.38, notablePlayers: ['YOSHIMURA Maharu', 'ISHIKAWA Kasumi'] },
